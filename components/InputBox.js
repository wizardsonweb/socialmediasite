        ...
        <div className="bg-white p-2 rounded-2xl shadow-md text-gray-100 font-medium mt-6">
            <div className="flex space-x-4 p-4 items-center">
                ...
                <form className="flex flex-1">
                    <input className="rounded-full h-12 bg-gray-100 flex-grow px-5 focus:outline-none text-gray-700" type="text" ref={inputRef} placeholder={`What's on your mind, ${session.user.name}?`}/>
            ...
            <div className="flex justify-evenly p-4 border-t">
                ...
                <div className="inputIcon">
                    ...
                    <p className="text-xs sm:text-sm xl:text-base">Feeling/Acticity</p>
                </div>
            </div>
        </div>
    )
